...
# print len(list_interaction_energy_a)
...
for (a,b) in zip(list_length_b_non_contiguous, list_interaction_energy_b_non_contiguous):
	print a,",", '{0:.3f}'.format(b)


# for (a,b) in zip(list_length_b, list_interaction_energy_b):
# 	print a, '{0:.3f}'.format(b)

# IMPORTANT JUNK OF CODE

# x_line_length = [320 for x in range(7)]
