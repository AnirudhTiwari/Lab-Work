					...
					if r[:4]==pdb_id[:4].lower() and chain.lower()==r[4].lower():					
						if frags==0:
							...
							while simulated_domains!=7:
								...
								if (length < 150 or interaction_energy > 0.04 or radius < 16) and simulated_domains==2:
									
									if domains==1:
										answer["single"]+=1

									else:
										print "Incorrectly identified as single domain protein"
										print pdb_id.strip()

									break

								if (length < 320 or interaction_energy > 0.06 or radius < 20) and simulated_domains==3:
									if domains==2:
										if segmented==True:
											answer["two_nc"]+=1
										else:
								...
								if (length < 250 or interaction_energy > 0.06 or radius < 22) and simulated_domains==4:
									if domains==3:
										if segmented==True:
											answer["three_nc"]+=1
										else:
								...
								if (length < 450 or interaction_energy > 0.08 or radius < 30) and simulated_domains==5:
									if domains==4:
										if segmented==True:
											answer["four_nc"]+=1
										else:
...
print "Correctly identified single domains ", answer["single"]
print "Correctly identified Contiguous Two Domains", answer["two_c"]
print "Correctly identified Non-Contiguous Two Domains", answer["two_nc"]
print "Correctly identified Contiguous Three Domains", answer["three_c"]
print "Correctly identified Non-Contiguous Three Domains", answer["three_nc"]
print "Correctly identified Contiguous Four Domains", answer["four_c"]
print "Correctly identified Non-Contiguous Four Domains", answer["four_nc"]
print "Correctly identified Five domains ", answer["five"]
