#This file only exists for experimental purpose! So that I can apply k-means + fragment stitching on a given chain for given clusters
...
#Main loop of the program which calculates the boundaries and outputs the final results.
	...
	for input_chain in input_chains:
		...
		cathBoundaries = getCathBoundaries(domain_boundary, int(cath_entry[7] + cath_entry[8]))
